...
public class BetaVariant extends virusVariant{
	...
	public int function(int durability1,int life2,int boost1,int attack1,int v1) {
		...
		System.out.println("Vaccine’s BOOST : 20 | Vaccine’s DURABILITY : 150 | Virus’s LIFE : 100 | Virus Variant: BETA");
		  int choice;
		  int v=v1;
		  do
		  {
			  ...
			  {
				  System.out.println("\nVirus Defeated !\r\n"
				  		+ "Vaccine proves to be effective during the second wave!!!\r\n"
			  ...
			  if(durability<=0) {
				  System.out.println("Vaccine’s DURABILITY : 0 | Virus’s LIFE : "+ life +"\r\n" 
				  		+ "Oops! Your vaccine fails to affect the Beta Variant.\r\n"
