...
public class GamaVariant extends virusVariant {
	...
	public int function(int durability1,int life2,int boost1,int attack1,int v1) {
		...
		System.out.println("Vaccine’s BOOST : 20 | Vaccine’s DURABILITY : 200 | Virus’s LIFE : 200 | Virus Variant: GAMA");
		  int choice;
		  int v=v1;
		  do
		  {
			  ...
			  {
				  System.out.println("\nVirus Defeated !\r\n"
				  		+ "Vaccine proves to be effective during the third wave!!!\r\n"
			  ...
			  if(durability<0) {
				  System.out.println("Vaccine’s DURABILITY : 0 | Virus’s LIFE : "+ life +"\r\n" 
				  		+ "Oops! Your vaccine fails to affect the Gama Variant.\r\n"
